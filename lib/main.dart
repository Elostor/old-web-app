...
import 'package:OldWebApp/helpers/loading/loading_screen.dart';
...
import 'package:OldWebApp/services/bloc/connection/connection_bloc.dart';
import 'package:OldWebApp/services/bloc/connection/connection_state.dart';
import 'package:OldWebApp/services/bloc/simple_bloc_observer.dart';
import 'package:OldWebApp/services/router/app_router_delagate.dart';
import 'package:OldWebApp/services/router/app_router_parser.dart';
import 'package:OldWebApp/utilities/cubit/theme_cubit.dart';
                  ...
                  builder: (context, themeType) {
                    return BlocConsumer<ConnectionBloc, ConnectionBlocState>(
                      ...
                      builder: (context, state) {
                        context
                            .read<AppPageBloc>()
                            .add(const AppPageInitializeApp());
